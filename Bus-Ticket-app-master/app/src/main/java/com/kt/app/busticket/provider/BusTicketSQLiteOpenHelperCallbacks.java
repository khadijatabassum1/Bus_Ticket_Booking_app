package com.kt.app.busticket.provider;
 ...
 */
public class BusTicketSQLiteOpenHelperCallbacks {
    private static final String TAG = BusTicketSQLiteOpenHelperCallbacks.class.getSimpleName();
